...
- [x] 2. Archive old verification handler code
  - [x] 2.1 Move verification handler files to archive
  ...
  - [x] 2.3 Remove original source files
...
- [x] 3. Checkpoint — Verify teardown is clean
...
- [x] 4. Create Dockerfile and switch MakeCallStreamFunction to Docker Lambda
  - [x] 4.1 Create Dockerfile
  ...
  - [x] 4.2 Update MakeCallStreamFunction to PackageType: Image
...
- [x] 5. Checkpoint — Verify Docker infrastructure
