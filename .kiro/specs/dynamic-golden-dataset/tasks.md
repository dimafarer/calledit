...
- [ ] 1. Static dataset migration and core data models
  - [ ] 1.1 Add `time_sensitive: true` flag to base-010 in `eval/golden_dataset.json`
  ...
  - [ ] 1.2 Create `eval/dataset_merger.py` with `load_and_merge()` and `merge_datasets()`
...
- [ ] 2. Checkpoint — Ensure merger tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Generator script — core framework and deterministic templates
  - [ ] 3.1 Create `eval/generate_dynamic_dataset.py` with main entry point and template registry
  ...
  - [ ] 3.2 Implement deterministic immediate-mode templates (>= 3 templates)
  ...
  - [ ] 3.3 Implement deterministic at_date-mode templates (>= 1 deterministic + brave templates in 4.2)
  ...
  - [ ] 3.4 Implement deterministic before_date-mode templates (>= 1 deterministic + brave templates in 4.3)
...
- [ ] 4. Generator script — Brave Search templates and remaining modes
  - [ ] 4.1 Implement brave_search immediate-mode templates
  ...
  - [ ] 4.2 Implement brave_search at_date-mode templates
...
- [ ] 5. Checkpoint — Ensure generator and property tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 6. Prediction quality and diversity
  - [ ] 6.1 Ensure difficulty and domain diversity across all templates
...
- [ ] 7. Eval runner integration
  - [ ] 7.1 Add `--dynamic-dataset` CLI argument to all three eval runners
  ...
  - [ ] 7.2 Add `dataset_sources` to eval report metadata
...
- [ ] 8. Validation extension
  - [ ] 8.1 Extend `eval/validate_dataset.py` to support dynamic dataset validation
