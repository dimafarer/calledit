...
def append_score(report: dict, path: str = DEFAULT_HISTORY_PATH) -> None:
    ...
    entry = {
        ...
        "architecture": report.get("architecture", "serial"),
        "model_config": report.get("model_config", {}),
        "vb_centric_score": report.get("vb_centric_score"),
        "per_agent_aggregates": report.get("per_agent_aggregates", {}),
        "per_category_accuracy": report.get("per_category_accuracy", {}),
        "verification_quality_aggregates": report.get("verification_quality_aggregates", {}),
